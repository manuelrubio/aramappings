...
Functions for computing ARA mappings
...
- [`ara_ordered_linf()`](https://manuelrubio.github.io/aramappings/reference/ara_ordered_linf.md)
  : Ordered Adaptable Radial Axes (ARA) mappings using the L-infinity
  norm
...
- [`ara_unconstrained_linf()`](https://manuelrubio.github.io/aramappings/reference/ara_unconstrained_linf.md)
  : Unconstrained Adaptable Radial Axes (ARA) mappings using the
  L-infinity norm

## Plotting functions

Functions for creating an ARA plot
