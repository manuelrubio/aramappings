...
A. Sanchez, and D. J. Lehmann (2017), doi: 10.1111/cgf.13196), which
...
the L-infinity vector norm. Specifically, it solves equivalent linear
problems as described in (12). Optional non-negative weights (`weights`)
