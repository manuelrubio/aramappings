...
#'
#' @description
#' \code{ara_ordered_L2()} computes \strong{ordered} \strong{Adaptable Radial Axes} (ARA) mappings for
#' the \strong{L2 norm}
#'
#' @details
#' \code{ara_ordered_L2()} computes low-dimensional point representations of high-dimensional
...
#' function solves the constrained optimization problem in Eq. (14), for the squared-Euclidean norm. The inequality
...
ara_ordered_L2 <- function(
  ...
  if ((!pracma::strcmpi(solver, "clarabel")) && (!pracma::strcmpi(solver, "CVXR"))) {
