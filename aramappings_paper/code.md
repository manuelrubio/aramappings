...
``` r
################################################################################
#######  Prepare data, axis vectors, and weights for Figures 2, 3, and 4  ######
################################################################################
...
# Genearate the ARA plot
filename <- "Figure_2a_Auto-mpg_ARA_unconstrained_l2.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_2a_Auto-mpg_ARA_unconstrained_l2.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_2b_Auto-mpg_ARA_unconstrained_l2_weights.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_2b_Auto-mpg_ARA_unconstrained_l2_weights.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_2c_Auto-mpg_ARA_exact_l2.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_2c_Auto-mpg_ARA_exact_l2.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_2d_Auto-mpg_ARA_ordered_l2.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_2d_Auto-mpg_ARA_ordered_l2.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_3a_Auto-mpg_ARA_unconstrained_l1.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_3a_Auto-mpg_ARA_unconstrained_l1.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_3b_Auto-mpg_ARA_unconstrained_L1_weights.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_3b_Auto-mpg_ARA_unconstrained_L1_weights.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_3c_Auto-mpg_ARA_exact_L1.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_3c_Auto-mpg_ARA_exact_L1.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_3d_Auto-mpg_ARA_ordered_L1.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_3d_Auto-mpg_ARA_ordered_L1.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_4a_Auto-mpg_ARA_unconstrained_linf.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_4a_Auto-mpg_ARA_unconstrained_linf.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_4b_Auto-mpg_ARA_unconstrained_linf_weights.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_4b_Auto-mpg_ARA_unconstrained_linf_weights.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_4c_Auto-mpg_ARA_exact_linf.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_4c_Auto-mpg_ARA_exact_linf.pdf
```
...
# Genearate the ARA plot
filename <- "Figure_4d_Auto-mpg_ARA_ordered_linf.pdf"
pdf(file = filename)
print(draw_radial_axes_plot_2d_standardized(
  Z,
  X,
...
```
## Created subfigure: Figure_4d_Auto-mpg_ARA_ordered_linf.pdf
```
...
##  [1] liver_1.24           viridis_0.6.5        viridisLite_0.4.2    RSpectra_0.16-2      pracma_2.4.6         ggplot2_4.0.0       
##  [7] aramappings_0.1.0    testthat_3.2.3       geometry_0.5.2       ascentTraining_1.0.0 devtools_2.4.6       usethis_3.2.1       
## 
## loaded via a namespace (and not attached):
##  [1] gtable_0.3.6       glpkAPI_1.3.4.1    xfun_0.54          remotes_2.5.0      processx_3.8.6     lattice_0.22-7     callr_3.7.6       
##  [8] vctrs_0.6.5        tools_4.5.2        ps_1.9.1           curl_7.0.0         parallel_4.5.2     tibble_3.3.0       pkgconfig_2.0.3   
## [15] Matrix_1.7-4       RColorBrewer_1.1-3 S7_0.2.0           desc_1.4.3         lifecycle_1.0.4    compiler_4.5.2     farver_2.1.2      
## [22] CVXR_1.0-15        brio_1.1.5         htmltools_0.5.8.1  yaml_2.3.10        gmp_0.7-5          pillar_1.11.1      pkgdown_2.2.0     
## [29] ellipsis_0.3.2     clarabel_0.11.1    cachem_1.1.0       sessioninfo_1.2.3  abind_1.4-8        digest_0.6.37      slam_0.1-55       
## [36] purrr_1.2.0        labeling_0.4.3     magic_1.6-1        rprojroot_2.1.1    fastmap_1.2.0      cli_3.6.5          magrittr_2.0.4    
## [43] pkgbuild_1.4.8     withr_3.0.2        Rmpfr_1.1-2        scales_1.4.0       bit64_4.6.0-1      rmarkdown_2.30     httr_1.4.7        
## [50] bit_4.6.0          gridExtra_2.3      memoise_2.0.1      evaluate_1.0.5     knitr_1.50         Rglpk_0.6-5.1      rlang_1.1.6       
## [57] Rcpp_1.1.0         glue_1.8.0         pkgload_1.4.1      rstudioapi_0.17.1  R6_2.6.1           fs_1.6.6
```
